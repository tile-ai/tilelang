...
install_pip="python3.9 -m pip install --upgrade pip && python3.9 -m pip install -r requirements-build.txt"

tox_command="python3.9 -m tox -e py38-pypi,py39-pypi,py310-pypi,py311-pypi,py312-pypi,audit_2_27"
