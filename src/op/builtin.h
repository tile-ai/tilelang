...
// The cost model ranking free-mode layout attempts: "register-count"
// (default) automatically uses reduction-aware scoring for CUDA reducers
// and spill/register scoring elsewhere. "io-aware" scores global-memory
// vector width / coalescing weighted by bytes moved, with registers as
// the tiebreak.
