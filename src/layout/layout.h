...
// Ours (FP4 ALIGN16B gap-aware); origin/main has no equivalent. Kept lowercase
// to match its definition + FFI binding in gemm_layouts.cc / layout.cc.
Layout makeAlign16BSwizzleLayout(const tirx::Buffer &buffer);
