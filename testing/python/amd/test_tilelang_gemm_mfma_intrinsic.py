...
def test_assert_tl_matmul():
    assert_tl_matmul_correctness(128, 128, 128, T.float16, T.float16)
    assert_tl_matmul_correctness(128, 256, 256, T.float16, T.float32)
    assert_tl_matmul_correctness(128, 256, 256, T.float16, T.float32, k_pack=2)
    assert_tl_matmul_correctness(128, 128, 128, T.int8, T.int32, accum_dtype=T.int32)
    assert_tl_matmul_correctness(128, 256, 256, T.int8, T.int32, accum_dtype=T.int32)
    assert_tl_matmul_correctness(128, 256, 256, T.int8, T.int32, accum_dtype=T.int32, k_pack=2)
    assert_tl_matmul_correctness(128, 256, 256, T.int8, T.int32, b_transposed=False, accum_dtype=T.int32)
    assert_tl_matmul_correctness(128, 256, 256, T.int8, T.int32, b_transposed=False, accum_dtype=T.int32, k_pack=2)
    assert_tl_matmul_correctness(128, 128, 128, T.float8_e4m3fnuz, T.float16)
