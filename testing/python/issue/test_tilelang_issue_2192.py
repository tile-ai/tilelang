...
def test_ws_no_spurious_syncthreads_in_loop():
    ...
    # No __syncthreads() should appear inside the pipeline loop between the
    # two warp-specialized branches; mbarriers handle cross-group ordering.
    in_loop = False
    loop_depth = 0
    spurious_syncs = []
