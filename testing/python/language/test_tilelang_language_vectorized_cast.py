...
@pytest.mark.parametrize(
    ...
    [
        ...
        (T.float32, T.float8_e4m3, "__nv_cvt_float2_to_fp8x2", 2),
        (T.float32, T.float8_e4m3, "__nv_cvt_float2_to_fp8x2", 4),
        ...
        (T.float8_e4m3, T.float32, "__tl_cvt_fp8x2_to_float2", 2),
        (T.float8_e4m3, T.float32, "__tl_cvt_fp8x2_to_float2", 4),
