...
def test_vectorized_cast():
    # fp32 -> fp16
    run_vectorized_cast(T.float32, T.float16, "__float22half2_rn", 2)
    run_vectorized_cast(T.float32, T.float16, "__float22half2_rn", 4)

    # fp16 -> fp32
    run_vectorized_cast(T.float16, T.float32, "__half22float2", 2)
    ...
    run_vectorized_cast(T.float32, T.bfloat16, "__float22bfloat162_rn", 4)

    # bf16 -> fp32
    run_vectorized_cast(T.bfloat16, T.float32, "__bfloat1622float2", 2)
