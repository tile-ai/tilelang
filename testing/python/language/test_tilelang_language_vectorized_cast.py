...
@pytest.mark.parametrize(
    ...
    [
        ("float32", T.float16, "__float22half2_rn", 2),
        ("float32", T.float16, "__float22half2_rn", 4),
        (T.float16, "float32", "__half22float2", 2),
        (T.float16, "float32", "__half22float2", 4),
        ...
        ("float32", T.bfloat16, "__float22bfloat162_rn", 2),
        ("float32", T.bfloat16, "__float22bfloat162_rn", 4),
        (T.bfloat16, "float32", "__bfloat1622float2", 2),
        (T.bfloat16, "float32", "__bfloat1622float2", 4),
