...
def test_loop_tail_split(block_M, block_N, block_K, threads, vec_load_b, dtype):
    ...
    class Before:
        ...
        def main(
            ...
            with T.Kernel(
                T.ceildiv(N, block_N), threads=threads
            ) as (bx):
