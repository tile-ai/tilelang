...
def run_general_reduction_recommend_hints(structure:str = "SSR", shape:List[int] = [1024, 1024, 1024], dtype:str = "float16", topk: int = 20):
...
def run_elementwise_recommend_hints(shape:List[int] = [1024, 1024], dtype:str = "float16", topk: int = 20):
    arch = auto_infer_current_arch()
...
def run_matmul_recommend_hints(M:int = 1024, N:int = 1024, K:int = 1024,
                               in_dtype:str = "float16", out_dtype:str = "float16", accum_dtype:str = "float16",
):
    arch = auto_infer_current_arch()
...
def run_gemv_recommend_hints(N:int = 1024, K:int = 1024, in_dtype:str = "float16", out_dtype:str = "float16", accum_dtype:str = "float16"):
    arch = auto_infer_current_arch()
