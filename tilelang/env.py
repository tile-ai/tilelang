...
TILELNAG_AUTO_TUNING_CPU_UTILITIES: str = os.environ.get("TILELNAG_AUTO_TUNING_CPU_UTILITIES",
                                                         "0.9")

# CPU COUNTS for Auto-Tuning, default is -1,
# which will use TILELNAG_AUTO_TUNING_CPU_UTILITIES * get_available_cpu_count()
TILELNAG_AUTO_TUNING_CPU_COUNTS: str = os.environ.get("TILELNAG_AUTO_TUNING_CPU_COUNTS", "-1")

# Max CPU Count for Auto-Tuning, default is 100
TILELNAG_AUTO_TUNING_MAX_CPU_COUNT: str = os.environ.get("TILELNAG_AUTO_TUNING_MAX_CPU_COUNT", "-1")
