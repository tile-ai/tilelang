...
def abs(x: _T, span: Optional[Span]=None) -> _T:
    ...
...
def address_of(buffer_load: BufferLoad, span: Optional[Span]=None) -> PrimExpr:
    ...
...
def bitwise_and(x: _T, y: _T, span: Optional[Span]=None) -> _T:
    ...

def bitwise_not(x: _T, span: Optional[Span]=None) -> _T:
    ...

def bitwise_or(x: _T, y: _T, span: Optional[Span]=None) -> _T:
    ...

def bitwise_xor(x: _T, y: _T, span: Optional[Span]=None) -> _T:
    ...

def ceil(x: _T, span: Optional[Span]=None) -> _T:
    ...
...
def floor(x: _T, span: Optional[Span]=None) -> _T:
    ...

def ceildiv(lhs: _T, rhs: _T, span: Optional[Span]=None) -> _T:
    ...

def floordiv(a: _T, b: _T, span: Optional[Span]=None) -> _T:
    ...

def floormod(a: _T, b: _T, span: Optional[Span]=None) -> _T:
    ...
...
def if_then_else(cond: PrimExpr, t: _T, f: _T, span: Optional[Span]=None) -> _T:
    ...

def infinity(dtype: _T, span: Optional[Span]=None) -> _T:
    ...

def isfinite(x: _T, span: Optional[Span]=None) -> _T:
    ...

def isinf(x: _T, span: Optional[Span]=None) -> _T:
    ...

def isnan(x: _T, span: Optional[Span]=None) -> _T:
    ...

def isnullptr(x: _T, span: Optional[Span]=None) -> _T:
    ...

def ldexp(x1: _T, x2: _T) -> _T:
    ...

def likely(cond: _T, span: Optional[Span]=None) -> _T:
    ...
...
def lookup_param(param_name: str, span: Optional[Span]=None) -> PrimExpr:
    ...

def max_value(dtype: str, span: Optional[Span]=None) -> PrimExpr:
    ...

def min_value(dtype: str, span: Optional[Span]=None) -> PrimExpr:
    ...

def nearbyint(x: _T, span: Optional[Span]=None) -> _T:
    ...
...
def pow(x: _T, y: _T, span: Optional[Span]=None) -> _T:
    ...

def q_multiply_shift(x: _T, y: _T, q: _T, s: _T) -> _T:
    ...

def q_multiply_shift_per_axis(x: PrimExpr, y: PrimExpr, ls: PrimExpr, rs: PrimExpr, q: IntImm, is_lshift_required: IntImm, is_rshift_required: IntImm) -> PrimExpr:
    ...

def ret(val: _T) -> _T:
    ...

def round(x: _T, span: Optional[Span]=None) -> _T:
    ...

def rsqrt(x: _T) -> _T:
    ...

def shift_left(x: PrimExpr, y: PrimExpr, span=None) -> PrimExpr:
    ...

def shift_right(x: PrimExpr, y: PrimExpr, span=None) -> PrimExpr:
    ...
...
def trunc(x: _T, span: Optional[Span]=None) -> _T:
    ...

def truncdiv(a: _T, b: _T, span: Optional[Span]=None) -> _T:
    ...

def truncmod(a: _T, b: _T, span: Optional[Span]=None) -> _T:
    ...
