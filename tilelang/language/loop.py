...
from tilelang.language.v2.builder import SteppedSerial
from tvm import tir
import tvm.script.tir as tb
...
def serial(start: tir.PrimExpr,
    ...
    if step is None or step == 1:
        return tb.serial(start, stop, annotations=annotations)
    else:
        return SteppedSerial(start, stop, step, annotations)
