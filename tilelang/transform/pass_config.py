...
class PassConfigKey(str, Enum):
    ...
    TL_DISABLE_MERGE_SHARED_MEMORY_ALLOCATIONS = "tl.disable_merge_shared_memory_allocations"
    """Disable the MergeSharedMemoryAllocations pass entirely. Default: False"""
