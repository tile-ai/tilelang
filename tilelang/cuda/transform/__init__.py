...
def AutoSchedule(scheduler: str):
    """Derive a warp-specialization schedule with the named scheduler
    (currently ``"role_based"``).
    ...
    fpass : tvm.transform.Pass
        The result pass
    """
    return _ffi_api.AutoSchedule(scheduler)  # type: ignore
