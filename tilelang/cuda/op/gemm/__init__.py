...
from .gemm_mma_sm120 import GEMM_INST_MMA_BLOCK_SCALED, GemmMMASm120
...
register_gemm_impl("cuda.mma_sm120", GEMM_INST_MMA_BLOCK_SCALED, _match_mma_sm120, GemmMMASm120)
