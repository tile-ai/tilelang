...
def tilelang_wy_fast_bwd(
    ...
    with T.Kernel(T.ceildiv(S, block_S), B * H, threads=threads) as (bs, bbh):
        ...
        for i_k in T.Pipelined(T.ceildiv(DK, block_DK), num_stages=num_stages):
            ...
            T.copy(dk_in[bb, bs * block_S : (bs + 1) * block_S, bh, i_k * block_DK : (i_k + 1) * block_DK], dk_old_shared)
            T.copy(dg_in[bb, bs * block_S : (bs + 1) * block_S, bh, i_k * block_DK : (i_k + 1) * block_DK], dg_old_shared)
