...
def tilelang_chunk_kda_fwd_inter_fused(
    ...
    Akk_diag: T.Tensor[[B, S, H, BC], T.float32]
    Aqk = T.empty([B, S, H, BS], output_dtype)
    Akk = T.empty([B, S, H, BS], output_dtype)
    """
...
def run_test(
    ...
    Aqk_tilelang, Akk_tilelang = tilelang_chunk_kda_fwd_inter_fused(
        q,
        k,
        gk,
        beta,
    ...
    tilelang_time = do_bench(
        tilelang_chunk_kda_fwd_inter_fused,
        q,
        k,
        gk,
        beta,
