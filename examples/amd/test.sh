python /workspace/tilelang/examples/amd/example_amd_flash_attn_fwd.py     --batch 2     --seq_len 4096     --dim 128     --heads 16     --groups 8     --is_causal
/workspace/composable_kernel/build/bin/tile_example_fmha_fwd \
    -b=2 \
    -s=4096 \
    -d=128 \
    -h=16 \
