...
def flashattn(
    ...
    K: T.Tensor[[num_pages, page_block_size, heads_kv, dim], dtype]
    V: T.Tensor[[num_pages, page_block_size, heads_kv, dim_v], dtype]
...
def run_regression_perf(args):
    ...
    def run_kernel_only():
        sparse_kernel.forward(Q, K_cache, V_cache, block_indices, cache_seqlens, block_table)
