...
def flashattn(batch, heads, heads_kv, dim, dim_v):
    ...
    def kernel_func(
        block_N, block_H, page_block_size, num_split, num_stages, threads, num_pages,
...
def ref_program_torch_paged(
    query, key_cache, value_cache, block_indices, cache_seqlens, block_table, page_block_size,
    block_size
):
    """
...
def main(args):
    ...
    if sparse_ratio == 0.0:
        ...
        assert torch.allclose(
            output_ref_fa, output_ref_torch, atol=1e-2
