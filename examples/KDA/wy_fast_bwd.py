    ...
    def kernel(
        ...
        with T.Kernel(T.ceildiv(S, block_S), B * H, threads=threads) as (bs, bbh):
            ...
            for i_k in T.Pipelined(T.ceildiv(DK, block_DK), num_stages=num_stages):
                ...
                for i_s, i_k2 in T.Parallel(block_S, block_DK):
                    dk_fragment[i_s, i_k2] = dk_fragment_beta_g[i_s, i_k2] * GK_shared_exp[i_s, i_k2] * Beta_shared[i_s] + dk_old_shared[i_s, i_k2]
            ...
            for i_s1, i_s2 in T.Parallel(block_S, block_S):
                dA_shared[i_s1, i_s2] = T.if_then_else(i_s1>i_s2, dA_fragment[i_s1, i_s2], 0.)
            ...
            for i_s1, i_s2 in T.Parallel(block_S, block_S):
                dA_fragment_tmp2[i_s1, i_s2] = T.if_then_else(i_s1>i_s2, -dA_fragment_tmp2[i_s1, i_s2], 0.)
...
def run_test(
    ...
    fla_time = do_bench(prepare_wy_repr_bwd, 
        k=K, 
        v=V, 
        gk=GK, 
        beta=Beta, 
