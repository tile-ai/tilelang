    ...
    def kernel(
        ...
        with T.Kernel(T.ceildiv(DK, block_DK), T.ceildiv(S, block_S), B * H, threads=threads) as (bk, bs, bbh):
            ...
            for i_s4, i_k4 in T.Parallel(block_S, block_DK):
                dgk_shared[i_s4, i_k4] = Q_shared[i_s4, i_k4] * dq_fragment[i_s4, i_k4] - K_shared[i_s4, i_k4]*dk_fragment[i_s4, i_k4] + T.if_then_else(chunk_last_idx==bs*block_S+i_s4, pp_shared[i_k4],0.0)
