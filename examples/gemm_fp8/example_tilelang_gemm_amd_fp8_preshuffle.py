...
def assert_tl_matmul_correctness(M,
    ...
    out_dtype = T.float32
    accum_dtype = T.float32
    kernel = tl_matmul(M, N, K, k_pack=k_pack, in_dtype=in_dtype, out_dtype=out_dtype, accum_dtype=accum_dtype, a_transposed=a_transposed, b_transposed=b_transposed, b_preshuffle=b_preshuffle)
