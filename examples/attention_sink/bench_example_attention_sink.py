...
def bench_example_mha_sink_fwd_bhsd():
    tilelang.testing.benchmark.process_func(example_mha_sink_fwd_bhsd.benchmark)
...
def bench_example_mha_sink_fwd_bhsd_wgmma_pipelined():
    tilelang.testing.benchmark.process_func(example_mha_sink_fwd_bhsd_wgmma_pipelined.benchmark)
...
def bench_example_gqa_sink_fwd_bhsd_wgmma_pipelined():
    tilelang.testing.benchmark.process_func(example_gqa_sink_fwd_bhsd_wgmma_pipelined.benchmark)
...
def bench_example_mha_sink_bwd_bhsd():
    tilelang.testing.benchmark.process_func(example_mha_sink_bwd_bhsd.benchmark)
...
def bench_example_gqa_sink_bwd_bhsd():
    tilelang.testing.benchmark.process_func(example_gqa_sink_bwd_bhsd.benchmark)
