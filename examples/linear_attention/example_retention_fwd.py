...
@tl.jit(pass_configs={"tl.disable_tma_lower": True, "tl.disable_warp_specialized": True})
def chunk_retention_fwd_kernel(
    ...
    B, S, H, DK, DV = T.const("B, S, H, DK, DV")
...
def main():
    ...
    t = do_bench(lambda: postprocess(chunk_retention_fwd_kernel(q, k, v)), warmup=25, rep=100)
