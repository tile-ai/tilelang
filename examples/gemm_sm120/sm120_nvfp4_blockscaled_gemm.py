...
79a. Run from the repository root:
    ...
    python examples/gemm_sm120/sm120_nvfp4_blockscaled_gemm.py --m 8192 --n 8192 --k 8192 --run-cutlass
"""
...
def _device_compile_flags() -> list[str]:
    flags = ["-DTL_SM120_FULLTILE_CUTLASS_SF_BASEPTR=1"]
