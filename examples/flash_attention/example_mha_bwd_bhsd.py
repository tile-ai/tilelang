...
def flashattn_fwd(Q, K, V, is_causal: bool = False, block_M: int = 64, block_N: int = 64):
    ...
    K: T.Tensor[[batch, heads, seq_len, dim], T.float16]
    V: T.Tensor[[batch, heads, seq_len, dim], T.float16]
...
def flashattn_bwd(Q, K, V, dO, lse, Delta, dQ, dK, dV, is_causal: bool = False, block_M: int = 64, block_N: int = 64):
    ...
    dQ: T.Tensor[[batch, heads, seq_len, dim], T.float32]
    dK: T.Tensor[[batch, heads, seq_len, dim], T.float16]
    dV: T.Tensor[[batch, heads, seq_len, dim], T.float16]
