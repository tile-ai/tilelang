...
def bench_example_gqa_bwd_tma_reduce_varlen():
    tilelang.testing.benchmark.process_func(example_gqa_bwd_tma_reduce_varlen.benchmark, name="example_gqa_bwd_tma_reduce_varlen")
...
def bench_example_gqa_bwd_wgmma_pipelined():
    tilelang.testing.benchmark.process_func(example_gqa_bwd_wgmma_pipelined.benchmark, name="example_gqa_bwd_wgmma_pipelined")
...
def bench_example_mha_bwd_bshd_wgmma_pipelined():
    tilelang.testing.benchmark.process_func(example_mha_bwd_bshd_wgmma_pipelined.benchmark, name="example_mha_bwd_bshd_wgmma_pipelined")


def bench_example_gqa_fwd_bshd_wgmma_pipelined():
    tilelang.testing.benchmark.process_func(
        example_gqa_fwd_bshd_wgmma_pipelined.benchmark, batch=1, heads=16, seq_len=1024, dim=128, is_causal=False, groups=16, tune=False
    )


def bench_example_gqa_fwd_bshd():
    tilelang.testing.benchmark.process_func(
        example_gqa_fwd_bshd.benchmark, batch=1, heads=16, seq_len=1024, dim=128, is_causal=False, groups=16, tune=False
    )
...
def bench_example_mha_fwd_bshd_wgmma_pipelined():
    tilelang.testing.benchmark.process_func(example_mha_fwd_bshd_wgmma_pipelined.benchmark, batch=1, heads=32, seq_len=256)
...
def bench_example_mha_fwd_varlen():
    tilelang.testing.benchmark.process_func(example_mha_fwd_varlen.benchmark, batch=4, heads=16, seq_len=512, dim=64)
