...
def tilelang_chunk_o_bwd_dqkwg(
    ...
    h: T.Tensor[[B, S // chunk_size, H, DK, DV], input_dtype]
    G: T.Tensor[[B, S, H], gate_dtype]
    dO: T.Tensor[[B, S, H, DV], input_dtype]
    dh: T.Tensor[[B, S // chunk_size, H, DK, DV], input_dtype]
    ...
    dq = T.empty([B, S, H, DK], output_dtype)
    dk = T.empty([B, S, H, DK], output_dtype)
    dw = T.empty([B, S, H, DK], output_dtype)
    dg = T.empty([NK, B, S, H], gate_dtype)
...
def run_test(
    ...
    # tilelang
    dq_tilelang, dk_tilelang, dw_tilelang, dg_tilelang = tilelang_chunk_o_bwd_dqkwg(
        Q,
        K,
        V,
        h,
