...
def check_outputs_equal(
    outputs_0_lst: List[TokensText], outputs_1_lst: List[TokensText], name_0: str, name_1: str
):
    """
...
def check_logprobs_close(
    outputs_0_lst: List[TokensTextLogprobs], outputs_1_lst: List[TokensTextLogprobs], name_0: str,
    name_1: str
):
    """
