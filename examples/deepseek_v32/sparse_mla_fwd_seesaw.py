...
def sparse_mla_fwd(
    ...
    Q: T.Tensor[[batch, seq_len, heads, dim + tail_dim], "bfloat16"]
    KV: T.Tensor[[batch, seq_len_kv, kv_group, dim + tail_dim], "bfloat16"]
    Indices: T.Tensor[[batch, seq_len, kv_group, topk], "int32"]
    q_start_index_s: T.Tensor[[1], "int32"]
...
def sparse_mla_fwd_interface(
    ...
    (
        out,
        lse,
    ) = sparse_mla_fwd(q, kv, indices, q_start_index_s_t, dim, tail_dim, kv_stride, kv_group, sm_scale, is_casual, CP0)
