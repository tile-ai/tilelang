            ...
            if tx >= 256:
                ...
                for i_i in T.serial(T.ceildiv(NI, 2)):
                    ...
                    if i_i + 1 < T.ceildiv(NI, 2):
                        ...
                        for r in T.serial(4):
                            prefetch_indices_0[r] = Indices[b_i, s_i, g_i, ((i_i + 1) * 2) * BI +
                                                            r * 16 + (tx - 256) // 8]
                ...
                for i_i in T.serial(T.ceildiv(NI, 2)):
                    ...
                    for h_i, bi_i in T.Parallel(H_per_block, BI):
                        acc_s_0[h_i, bi_i] = T.exp2(acc_s_0[h_i, bi_i] * sm_scale -
                                                    m_i_0[h_i] * sm_scale)
                ...
                for i_i in T.serial(T.ceildiv(NI, 2)):
                    ...
                    for h_i, bi_i in T.Parallel(H_per_block, BI):
                        acc_s_1[h_i, bi_i] = T.exp2(acc_s_1[h_i, bi_i] * sm_scale -
                                                    m_i_1[h_i] * sm_scale)
