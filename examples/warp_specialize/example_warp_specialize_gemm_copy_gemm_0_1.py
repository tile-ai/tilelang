...
def main():
    ...
    c = matmul_warp_specialize_copy_1_gemm_0(a, b, block_M=block_M, block_N=block_N, block_K=block_K)
    print(c)
    ...
    # cuda_source = matmul_warp_specialize_copy_1_gemm_0.get_kernel_source(a, b)
    # print("Generated CUDA kernel:\n", cuda_source)

    # 5.Profile latency with kernel
    kernel = matmul_warp_specialize_copy_1_gemm_0.compile(a, b, block_M=block_M, block_N=block_N, block_K=block_K)
