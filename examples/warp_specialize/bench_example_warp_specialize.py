...
def bench_example_warp_specialize_gemm_barrierpipe_stage2():
    tilelang.testing.benchmark.process_func(example_warp_specialize_gemm_barrierpipe_stage2.benchmark, M=1024, N=1024, K=1024)


def bench_example_warp_specialize_gemm_copy_0_gemm_1():
    tilelang.testing.benchmark.process_func(example_warp_specialize_gemm_copy_0_gemm_1.benchmark, M=1024, N=1024, K=1024)


def bench_example_warp_specialize_gemm_copy_1_gemm_0():
    tilelang.testing.benchmark.process_func(example_warp_specialize_gemm_copy_1_gemm_0.benchmark, M=1024, N=1024, K=1024)


def bench_example_warp_specialize_gemm_softpipe_stage2():
    tilelang.testing.benchmark.process_func(example_warp_specialize_gemm_softpipe_stage2.benchmark, M=1024, N=1024, K=1024)
