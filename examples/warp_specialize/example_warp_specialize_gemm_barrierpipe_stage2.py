...
def main(M=16384, N=16384, K=16384):
    ...
    c = matmul(a, b, block_M=block_M, block_N=block_N, block_K=block_K)

    print(matmul.get_kernel_source(a, b, block_M=block_M, block_N=block_N, block_K=block_K))
    ...
    kernel = matmul.compile(a, b, block_M=block_M, block_N=block_N, block_K=block_K)
