...
extern "C" __global__ void main_kernel(__grid_constant__ const CUtensorMap A_desc, __grid_constant__ const CUtensorMap B_desc);
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(__grid_constant__ const CUtensorMap A_desc, __grid_constant__ const CUtensorMap B_desc) {
  ...
  if (tl::tl_shuffle_elect<128>()) {
    ...
    tl::tma_load(B_desc, load_mbar_b[0], (&(((fp4_e2_t*)buf_dyn_shmem)[16384])), 0, 0);
  }
