...
extern "C" __global__ void bwd_kernel(float* __restrict__ Delta, int* __restrict__ Indices, bfloat16_t* __restrict__ KV, float* __restrict__ Lse, bfloat16_t* __restrict__ Q, float* __restrict__ dKV, bfloat16_t* __restrict__ dO, bfloat16_t* __restrict__ dQ);
extern "C" __global__ void __launch_bounds__(256, 1) bwd_kernel(float* __restrict__ Delta, int* __restrict__ Indices, bfloat16_t* __restrict__ KV, float* __restrict__ Lse, bfloat16_t* __restrict__ Q, float* __restrict__ dKV, bfloat16_t* __restrict__ dO, bfloat16_t* __restrict__ dQ) {
  ...
  #pragma unroll
  for (int i = 0; i < 16; ++i) {
    *(uint4*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 63) >> 3) * 4096) + (i * 256)) + ((((int)threadIdx.x) >> 6) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 127) >> 6) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 59392)) = *(uint4*)(Q + ((((((int)blockIdx.x) * 36864) + (i * 2304)) + ((((int)threadIdx.x) >> 6) * 576)) + ((((int)threadIdx.x) & 63) * 8)));
  }
  #pragma unroll
  ...
  for (int i_2 = 0; i_2 < 16; ++i_2) {
    *(uint4*)(((bfloat16_t*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 63) >> 3) * 4096) + (i_2 * 256)) + ((((int)threadIdx.x) >> 6) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_2 & 1)) & 1) * 32)) + ((((((int)threadIdx.x) >> 7) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 127) >> 6) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 26624)) = *(uint4*)(dO + (((((int)blockIdx.x) * 32768) + (i_2 * 2048)) + (((int)threadIdx.x) * 8)));
  }
  #pragma unroll
  ...
  for (int i_i = 0; i_i < 64; ++i_i) {
    ...
    if (((int)threadIdx.x) < 8) {
      int __1;
      ushort4 __2;
        int4 v_ = *(int4*)(Indices + ((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (((int)threadIdx.x) * 4)));
        int4 v__1 = make_int4(((((int)blockIdx.x) >> 1) + 28672), ((((int)blockIdx.x) >> 1) + 28672), ((((int)blockIdx.x) >> 1) + 28672), ((((int)blockIdx.x) >> 1) + 28672));
        __2.x = (v_.x<=v__1.x);
        __2.y = (v_.y<=v__1.y);
        __2.z = (v_.z<=v__1.z);
        __2.w = (v_.w<=v__1.w);
    ...
    for (int i_6 = 0; i_6 < 8; ++i_6) {
      uint4 condval_1;
      if (((0 <= Indices[(((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (i_6 * 4)) + (((int)threadIdx.x) >> 6))]) && (Indices[(((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (i_6 * 4)) + (((int)threadIdx.x) >> 6))] < 32768))) {
        condval_1 = *(uint4*)(KV + ((((int64_t)Indices[(((((((int64_t)((int)blockIdx.x)) >> (int64_t)1) * (int64_t)2048) + (((int64_t)i_i) * (int64_t)32)) + (((int64_t)i_6) * (int64_t)4)) + (((int64_t)((int)threadIdx.x)) >> (int64_t)6))]) * (int64_t)576) + ((((int64_t)((int)threadIdx.x)) & (int64_t)63) * (int64_t)8)));
      } else {
    ...
    __syncthreads();
    tl::gemm_ss<64, 32, 512, 4, 2, 0, 1, 0, true>((&(((bfloat16_t*)buf_dyn_shmem)[59392])), (&(((bfloat16_t*)buf_dyn_shmem)[10240])), (&(acc_p[0])));
    __syncthreads();
    uint4 condval_2;
    if (((0 <= Indices[((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (((int)threadIdx.x) >> 3))]) && (Indices[((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (((int)threadIdx.x) >> 3))] < 32768))) {
      condval_2 = *(uint4*)(KV + (((((int64_t)Indices[((((((int64_t)((int)blockIdx.x)) >> (int64_t)1) * (int64_t)2048) + (((int64_t)i_i) * (int64_t)32)) + (((int64_t)((int)threadIdx.x)) >> (int64_t)3))]) * (int64_t)576) + ((((int64_t)((int)threadIdx.x)) & (int64_t)7) * (int64_t)8)) + (int64_t)512));
    } else {
    ...
    *(uint4*)(((bfloat16_t*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 3) * 64) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)) = condval_2;
    ...
    tl::fence_proxy_async();
    __syncthreads();
    tl::gemm_ss<64, 32, 512, 4, 2, 0, 1, 0, true>((&(((bfloat16_t*)buf_dyn_shmem)[26624])), (&(((bfloat16_t*)buf_dyn_shmem)[10240])), (&(acc_dp[0])));
    #pragma unroll
    ...
    tl::fence_proxy_async();
    tl::gemm_ss<32, 512, 64, 1, 8, 1, 0, 0, false>((&(((bfloat16_t*)buf_dyn_shmem)[2048])), (&(((bfloat16_t*)buf_dyn_shmem)[59392])), (&(acc_dkv[0])));
    tl::gemm_ss<32, 512, 64, 1, 8, 1, 0, 0, false>((&(((bfloat16_t*)buf_dyn_shmem)[0])), (&(((bfloat16_t*)buf_dyn_shmem)[26624])), (&(acc_dkv[0])));
    #pragma unroll
    ...
    for (int s = 0; s < 2; ++s) {
      ...
      for (int i_16 = 0; i_16 < 8; ++i_16) {
        if (0 <= Indices[((((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (s * 16)) + (i_16 * 2)) + (((int)threadIdx.x) >> 7))]) {
          if (Indices[((((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (s * 16)) + (i_16 * 2)) + (((int)threadIdx.x) >> 7))] < 32768) {
            AtomicAddx4((&(dKV[((Indices[((((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (s * 16)) + (i_16 * 2)) + (((int)threadIdx.x) >> 7))] * 576) + ((((int)threadIdx.x) & 127) * 4))])), (&(((float*)buf_dyn_shmem)[(((i_16 * 1024) + (((int)threadIdx.x) * 4)) + 5120)])));
          }
        }
      }
      #pragma unroll
      for (int i_17 = 0; i_17 < 1; ++i_17) {
        if (0 <= Indices[(((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (s * 16)) + (((int)threadIdx.x) >> 4))]) {
          if (Indices[(((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (s * 16)) + (((int)threadIdx.x) >> 4))] < 32768) {
            AtomicAddx4((&(dKV[(((Indices[(((((((int)blockIdx.x) >> 1) * 2048) + (i_i * 32)) + (s * 16)) + (((int)threadIdx.x) >> 4))] * 576) + ((((int)threadIdx.x) & 15) * 4)) + 512)])), (&(((float*)buf_dyn_shmem)[((((int)threadIdx.x) * 4) + 2048)])));
          }
        }
      }
    }
...
extern "C" int init() {
    ...
    cudaError_t result_bwd_kernel = cudaFuncSetAttribute(bwd_kernel, cudaFuncAttributeMaxDynamicSharedMemorySize, 184320);
    if (result_bwd_kernel != CUDA_SUCCESS) {
        snprintf(error_buf, ERROR_BUF_SIZE, "Failed to set the allowed dynamic shared memory size to %d with error: %s", 184320, cudaGetErrorString(result_bwd_kernel));
        return -1;
    }
...
extern "C" int call(bfloat16_t* __restrict__ Q, bfloat16_t* __restrict__ KV, bfloat16_t* __restrict__ dO, int* __restrict__ Indices, float* __restrict__ Lse, float* __restrict__ Delta, bfloat16_t* __restrict__ dQ, float* __restrict__ dKV, cudaStream_t stream=cudaStreamDefault) {
	bwd_kernel<<<dim3(8192, 1, 1), dim3(256, 1, 1), 184320, stream>>>(Delta, Indices, KV, Lse, Q, dKV, dO, dQ);
	TILELANG_CHECK_LAST_ERROR("bwd_kernel");
